...
export const socialLinksData: socialLinksDataType = [
  ...
  {
    title: 'Github',
    url: 'https://github.com/MohamedSaid7102',
    logo: (
      <svg
        aria-hidden={true}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    title: 'Codepen',
    url: 'https://codepen.io/mohamedsaid7102',
    logo: (
      <svg
        aria-hidden={true}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    title: 'Telegram',
    url: 'https://telegram.me/Mohamed_S_Shelf',
    logo: (
      <svg
        aria-hidden={true}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    title: 'Instagram',
    url: 'https://www.instagram.com/mohamed__shelf/',
    logo: (
      <svg
        aria-hidden={true}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    title: 'Email',
    url: 'mailto:mohamedshelfwork@gmail.com',
    logo: (
      <svg
        aria-hidden={true}
        xmlns="http://www.w3.org/2000/svg"
